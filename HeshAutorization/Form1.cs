...
namespace HeshAutorization
{
    public partial class Form1 : Form
    {
        ...
        private void button_Aut_Click(object sender, EventArgs e)
        {
            ...
            openConnection();
            string commandString = $"select role from RegistrAftoriza where Login='{Login}' and Password='{PasswordZap}'";
        ...
        private void button_Reg_Click(object sender, EventArgs e)
        {
            ...
            if (PasswordReg1 == PasswordReg2)
            {
                    ...
                    else if (Proverka(LoginReg, PasswordReg1) == false)
                    {
                        ...
                        string commandString = $"insert into RegistrAftoriza(Login, Password, role) values('{LoginReg}', '{PasswordReg1}', '{role}')";
